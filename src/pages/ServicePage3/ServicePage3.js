						...
						<div className="block-service3">
							...
							<div className={!card ? "card" : "card active"}>
								...
								<div className="content">
									...
									<p>Цена: от {Math.floor(dollar * 100)},00p </p>
								</div>
							...
							<div className={!card2 ? "card" : "card active"}>
								...
								<div className="content">
									...
									<p>Вы можете воспользоваться услугами нашего дизайнера, который поможет Вам подобрать шрифт, цвет сайта, картинки и сделать сайт максимально удобным и простым для взаимодействия пользователя.</p>
									<br />
									<p>Цена: от {Math.floor((dollar * 3) * 100)},00p</p>
								</div>
							...
							<div className={!card3 ? "card" : "card active"}>
								...
								<div className="content">
									...
									<br />
									<p>Цена: {Math.floor((dollar / 2) * 100)},00p</p>
								</div>
							...
							<div className={!card4 ? "card" : "card active"}>
								...
								<div className="content">
									<h3>Сделаем сайт</h3>
									<p>Разработаем сайт для Вашего бизнеса с(без) дизайнером, с(без) регистрацией и авторизацией, с(без) подключением платежной системы, с(без) выбора языка, с(без) определением местоположения пользователя, с(без) административной панелью и т.д. Для размещения Вашего сайта в сети интернет необходим домен (назнавание сайта, например "app.by") и хостинг (место в интернете).</p>
									<br />
									<p>Цена: Цена: от {Math.floor(dollar * 100)},00p</p>
								</div>
							...
							<div className={!card6 ? "card" : "card active"}>
								...
								<div className="content">
									<h3>Корпоративное приложение</h3>
									...
									<br />
									<p>от {Math.floor((dollar * 10) * 100)},00p</p>
								</div>
								<button

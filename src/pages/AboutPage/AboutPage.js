							...
							<div className="about-block">
								...
								<div className="box-title">
									...
									<div className="about-content">
										<p>Наша команда разработчиков использует самые современные технологии.<br /> Нас выбирают не только потому что мы быстро и качественно выполняем свою работу и главное в срок, но и потому что мы внимательно и с пониманием относимся к пожеланиям заказчиков, а ещё мы
